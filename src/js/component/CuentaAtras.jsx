        ...
        <div className="container">
          <div className="row g-3 align-items-center justify-content-start my-3">
            <div className="col-auto">
              <label htmlFor="inputTime" className="col-form-label text-white">Time</label>
            </div>
            <div className="col-4">
              <input type="number" id="inputTime" className="form-control"/>
            </div>
            <div className="col-auto">
              <button className="btn btn-secondary mx-2 border" onClick={countDown}>Count Down</button>
            </div>
          </div>
          {mostrarModal ? <Alert/> : null}
        </div>
